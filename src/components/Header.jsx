  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-gray-900/95 backdrop-blur-sm shadow-lg">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-16">
        <a
          href="#hero"
          className="text-xl font-bold text-teal-400 hover:text-teal-300 transition duration-300 flex items-center"
        >
        ...
        <nav className="hidden md:flex space-x-6">
          ...
          <button>
            <a
              href="https://drive.google.com/file/d/1RBuLTe3igedknxDmnOmMMtdAmwVKPOeV/view?usp=sharing"
              className="text-gray-300 hover:text-teal-400 px-3 py-2 rounded-md text-sm font-medium transition duration-300"
              target="blank"
            >
              Resume
